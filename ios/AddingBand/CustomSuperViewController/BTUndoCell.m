...
- (void)createSubControls
{
  ...
  //  _contentImageView.backgroundColor = [UIColor blueColor];
    ...
    //内容Label
    self.contentLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.iconImageView.frame.origin.x , self.iconImageView.frame.origin.y - 10, 200, 40)];
...
-(void)layoutSubviews
{
    ...
    //内容Label的高度
    _contentLabel.frame = CGRectMake(_contentLabel.frame.origin.x, _contentLabel.frame.origin.y, _contentLabel.bounds.size.width, labelsize.height);
   //内容气泡图片的高度
