...
{
    CGRect frame = CGRectMake(0, POINT_TOP, 320, height);
    self = [super initWithFrame:frame];
    if (self) {
        _slime = [[SRSlimeView alloc] initWithFrame:
                  CGRectMake(0.0f, POINT_TOP, frame.size.width, frame.size.height)];
        
        //  _slime = [[SRSlimeView alloc] initWithFrame:
       //                   CGRectMake(0.0f, 0.0f, 200, 20)];
      ...
      //  _refleshView.center = CGPointMake(_slime.startPoint.x, POINT_TOP);
        
        _refleshView.bounds = CGRectMake(0.0f, POINT_TOP, kRefreshImageWidth, kRefreshImageWidth);
...
- (void)setFrame:(CGRect)frame
{
    ...
    if (_slime.state == SRSlimeStateNormal) {
        _slime.frame = CGRectMake(0.0f, POINT_TOP, frame.size.width, frame.size.height);
        _slime.startPoint = CGPointMake(frame.size.width / 2, _dragingHeight / 2);
    }
    _refleshView.center = CGPointMake(_slime.startPoint.x, POINT_TOP + 15.5);
    _activityIndicatorView.center = CGPointMake(_slime.startPoint.x, POINT_TOP + 15);
}
